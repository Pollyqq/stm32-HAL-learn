...
#define GRAPHIC_DMA2D_InitStruct hdma2d
extern DMA2D_HandleTypeDef GRAPHIC_DMA2D_InitStruct;
/* Internal structure */
typedef struct
{
	uint16_t Width;
...
typedef struct
{
	...
	DMA2D_LayerCfgTypeDef DMA2D_Layer;
} DMA2D_Layer_InitTypeDef;

/* Private structures */
//static DMA2D_Layer_InitTypeDef GRAPHIC_DMA2D_InitStruct;
...
{
	/* Set DMA2D settings */
	GRAPHIC_DMA2D_InitStruct.Instance = DMA2D;
	GRAPHIC_DMA2D_InitStruct.Init.ColorMode = DMA2D_RGB565;
	GRAPHIC_DMA2D_InitStruct.Init.Mode = DMA2D_R2M;

	/* Set colors */
	GRAPHIC_DMA2D_InitStruct.Init.OutputOffset = 0;
	GRAPHIC_DMA2D_InitStruct.LayerCfg[1].InputOffset = 0;
	GRAPHIC_DMA2D_InitStruct.LayerCfg[1].InputColorMode = DMA2D_INPUT_RGB565;
	GRAPHIC_DMA2D_InitStruct.LayerCfg[1].AlphaMode = DMA2D_NO_MODIF_ALPHA;
	GRAPHIC_DMA2D_InitStruct.LayerCfg[1].InputAlpha = 0;
