...
void lv_port_disp_init(void)
{
    ...
    //static lv_color_t draw_buf_2[LV_HOR_RES_MAX * LV_VER_RES_MAX] __attribute__((at(0x6804B000)));
...
static void disp_flush(lv_disp_drv_t *disp_drv, const lv_area_t *area, lv_color_t *color_p)
{
    ...
    //HAL_DMA2D_Start_IT(&hdma2d, (uint32_t)&color_p, LCD_DATA, x_end - x_start + 1, y_end - y_start + 1);
    //HAL_DMA2D_Start_IT(&hdma2d,(uint32_t)color_p,FSMC_ADDRESS,x_end - x_start + 1, y_end - y_start + 1);
    //HAL_Delay(50);
    /* IMPORTANT!!!
